...
public class CommonUtils {
	 ...
	 * @创建时间:	2019年7月3日 
	 */  
	public static int validateResults(int[] a){
	 ...
	 * @创建时间:	2019年7月3日 
	 */  
	public static int[] createIntArrays(int length, int max){
		if(max <= 0)throw new IllegalArgumentException("max的值应大于0. " + max);
